...
/**
 * The class is responsible for fetching all the Postcodes added to the shipping zone in WooCommerce Settings
 */
class WCPostCodes {
	...
	private function sendCurlRequest( $url ) {
		...
		curl_setopt_array( $curl, array(
			...
			CURLOPT_USERAGENT      => 'Wordpress Plugin: WC-Postcodes Names',
		) );
